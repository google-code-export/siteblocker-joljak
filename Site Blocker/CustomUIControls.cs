...
namespace CustomUIControls
{
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        protected Font normalTitleFont = new Font("맑은 고딕", 12, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverTitleFont = new Font("맑은 고딕", 12, FontStyle.Bold, GraphicsUnit.Pixel);
        protected Font normalContentFont = new Font("맑은 고딕", 11, FontStyle.Regular, GraphicsUnit.Pixel);
        protected Font hoverContentFont = new Font("맑은 고딕", 11, FontStyle.Regular, GraphicsUnit.Pixel);
